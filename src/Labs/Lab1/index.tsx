        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Heat oil over high in a large deep skillet or wok </li>
                    <li>Add onions and cook until lightly browned and softened, about 2 minutes.</li>
                    <li>Add hot dogs and cook, stirring constantly until browned.</li>
                    <li>Add in rice and sesame oil and cook, stirring constantly, about 1 minute.</li>
                    <li>Stir in ginger, garlic, salt and pepper.</li>
                </ol>
            ...
            <div id="wd-forms">
                ...
                <h4>Other HTML field types</h4>
                    ...
                    <h4>Anchor tag</h4>
                    Please <a id="wd-lipsum" href="http://www.lipsum.com"> click here </a>
                     to get dummy text<br />
                    
                    Please <a id="wd-github" href="https://github.com/RennieCh/kanbas-react-web-app-cs5610-fa24"> click here </a>
